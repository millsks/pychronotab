...
This document describes how to create and publish releases for pychronotab.
...
# Verify installation
python -c "import pychronotab; print(pychronotab.__version__)"
```
