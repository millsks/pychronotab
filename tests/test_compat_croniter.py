...
class TestCroniterCompat:
    ...
    def test_get_next_float(self):
        ...
        dt = datetime.fromtimestamp(next1, tz=timezone.utc)
        assert dt == datetime(2024, 1, 1, 12, 5, 0, tzinfo=timezone.utc)
    ...
    def test_set_current(self):
        ...
        new_time = datetime(2024, 1, 1, 15, 0, 0, tzinfo=timezone.utc)
        it.set_current(new_time)

        next1 = it.get_next(datetime)
        assert next1 == datetime(2024, 1, 1, 15, 5, 0, tzinfo=timezone.utc)
